            ...
            <div class="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                <div class="space-y-4">
                    <div>
                        ...
                        <h1 class="mt-3 text-3xl font-semibold">開発記録ドキュメント</h1>
                    </div>
                    <p class="text-sm leading-relaxed text-slate-300">
                        Development 配下のメモ・オペレーション・タスクをまとめて確認できます。各グループのカードから一覧へ移動してください。
                    </p>
                </div>
        ...
        @if ($memoCard)
            <div class="flex flex-col rounded-2xl border border-white/5 bg-slate-900/60 backdrop-blur shadow-lg shadow-black/20">
                <div class="flex items-center justify-between border-b border-white/5 px-5 py-4">
                    <div>
                        <p class="text-xs uppercase tracking-[0.3em] text-white/60">Development</p>
